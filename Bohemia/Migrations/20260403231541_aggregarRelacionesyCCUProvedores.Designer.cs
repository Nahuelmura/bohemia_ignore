...
namespace ProyectoBohemia.Migrations
{
    ...
    [Migration("20260403231541_aggregarRelacionesyCCUProvedores")]
    partial class aggregarRelacionesyCCUProvedores
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProyectoBohemia.Models.Cobro", b =>
                {
            ...
            modelBuilder.Entity("ProyectoBohemia.Models.CobroCheque", b =>
                {
                    b.Property<int>("CobroChequeID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CobroChequeID"));
            ...
            modelBuilder.Entity("ProyectoBohemia.Models.CobroDiferido", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CobroDiferidoID"));
            ...
            modelBuilder.Entity("ProyectoBohemia.Models.MovimientoCuentaCorriente", b =>
                {
                    b.Property<int>("MovimientoCuentaCorrienteID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MovimientoCuentaCorrienteID"));
            ...
            modelBuilder.Entity("ProyectoBohemia.Models.Venta", b =>
                {
                    ...
                    b.Property<int?>("VentaOriginalID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProyectoBohemia.Models.CobroCheque", b =>
                {
                    ...
                    b.HasOne("ProyectoBohemia.Models.Cobro", "Cobro")
                        .WithMany()
                        .HasForeignKey("CobroID");

                    b.Navigation("Cobro");

                    b.Navigation("CobroDiferido");
                });
            ...
            modelBuilder.Entity("ProyectoBohemia.Models.Venta", b =>
                {
                    ...
                    b.HasOne("ProyectoBohemia.Models.Venta", "VentaOriginal")
                        .WithMany()
                        .HasForeignKey("VentaOriginalID");
